"""
integrar_zip.py  –  Fernanda García
Toma los cuentos válidos extraídos de cuentos_fer.zip (ya filtrados por
temática de monstruos/criaturas), los copia como .txt a mis_cuentos/,
actualiza metadata_fernanda.csv y corre procesar_cuentos.py.

Uso:
    python3 integrar_zip.py
"""
...
CSV_VALIDOS    = Path("cuentos_validos_zip.csv")
...
def main():
    ...
    print(f"📋  {len(cuentos)} cuentos del zip a integrar\n")
